    ...
    return (
        <div className="flex flex-col items-center pt-16 bg-white">
          ...
          <div className="flex gap-2 mt-9 w-[469px] max-md:pr-5 text-base font-inter leading-6 text-zinc-500 justify-between">
            <input type="First Name" className="justify-center w-[230px] max-md:pr-5 px-4 py-3 bg-white rounded-lg border border-black border-solid shadow-sm" 
            placeholder='First Name'/>
            <input type = "Last Name" className="justify-center w-[234px] max-md:pr-5 px-4 py-3 bg-white rounded-lg border border-black border-solid shadow-sm"
            placeholder='Last Name'/>
          </div>
          {/* School Email Input */}
          <input type="email" className="justify-center items-start px-4 py-3 mt-6 max-w-full text-base font-inter leading-6 bg-white rounded-lg border border-black border-solid shadow-sm text-zinc-500 w-[469px] max-md:pr-5" 
          placeholder="School Email" />
          {/* Password Input */}
          <input type="password" className="justify-center items-start px-4 py-3 mt-5 max-w-full text-base font-inter leading-6 whitespace-nowrap bg-white rounded-lg border border-black border-solid shadow-sm text-zinc-500 w-[469px] max-md:pr-5"
          placeholder="Password"/>
          <button className="justify-center px-6 py-3.5 mt-9 text-xl font-interextra leading-8 text-white rounded-lg shadow-sm bg-blue-950 max-md:px-5">
